...
from recognize.ppocr.data.imaug.iaa_augment import IaaAugment
from recognize.ppocr.data.imaug.random_crop_data import is_poly_outside_rect
from recognize.utility import get_rotate_crop_image
